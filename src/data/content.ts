...
export const content = {
  es: {
    ...
    languagePath: '/en/',
    title: 'Nicolas Del Rosario — Desarrollador Full Stack IA',
    description: 'Portfolio de Nicolas Del Rosario, desarrollador Full Stack IA en Lima, Perú. Software, automatización y productos digitales confiables.',
  ...
  en: {
    ...
    languagePath: '/',
    title: 'Nicolas Del Rosario — Full-stack software developer in Lima',
    description: 'Portfolio of Nicolas Del Rosario, a full-stack software developer in Lima, Peru. Software, automation and reliable digital products.',
